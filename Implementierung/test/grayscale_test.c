...
void test_img_to_grayscale_naive(void) {
    ...
    ASSERT_TRUE("Grayscale Naive Basic Test", test_result);
    if (!test_result) {
        print_matrix_test_details(expected, actual, 10);
    }
}
...
void test_img_to_grayscale_naive_little_weights(void) {
    ...
    bool test_result = uint8_array_equal(expected, actual, 10);
    ASSERT_TRUE("Grayscale Naive Small Weight Coefficients Test", test_result);
    if (!test_result) {
        print_matrix_test_details(expected, actual, 10);
    }
}
...
void test_img_to_grayscale_simd_8_pixels(void) {
    ...
    bool test_result = uint8_array_equal(expected, actual, 10);
    ASSERT_TRUE("Grayscale SIMD with 8 pixels Basic Test", test_result);
    if (!test_result) {
        print_matrix_test_details(expected, actual, 10);
    }
}
...
void test_img_to_grayscale_simd_5_pixels(void) {
    ...
    img_to_grayscale_simd_5_pixels(img, 10, 1, 0.299f, 0.587f, 0.114f, actual);

    bool test_result = uint8_array_equal(expected, actual, 10);
    ASSERT_TRUE("Grayscale SIMD with 5 pixels Basic Test", test_result);
    if (!test_result) {
        print_matrix_test_details(expected, actual, 10);
    }
}
...
void test_img_to_grayscale_bitshift(void) {
    ...
    bool test_result = uint8_array_equal(expected, actual, 10);
    ASSERT_TRUE("Grayscale Bitshift Basic Test", test_result);
    if (!test_result) {
        print_matrix_test_details(expected, actual, 10);
    }
}